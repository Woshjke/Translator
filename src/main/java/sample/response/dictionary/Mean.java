...
public class Mean {
    ...
    public Mean(String text, String num, String pos, String gen, Translation[] tr, Synonym[] syn, Mean[] mean, Example[] ex) {
        this.text = text;
        this.num = num;
        this.pos = pos;
        this.gen = gen;
    ...
    public String toString() {
        StringBuilder stringBuilder = new StringBuilder("Значение:\n");
